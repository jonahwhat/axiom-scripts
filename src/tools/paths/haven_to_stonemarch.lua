...
local trodden = blocks.horizon.path_haven
local trodden_edge = blocks.horizon.path_stonemarch_grassy
local trodden_corner = blocks.horizon.path_stonemarch_grassy_corner
local trodden_slab = blocks.horizon.path_haven_slab
